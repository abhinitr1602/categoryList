    ...
    <div v-if="cart.length > 0">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="full-width">
          ...
          <br />
          <h5>
            Price ({{ addedProducts.length }} item) : <i class="fa fa-inr"></i>
            {{ selectedItemPrice }}
          </h5>
          <h5>Discount : <i class="fa fa-inr"></i> {{ discountAmount }}</h5>
          <br />
          <h4>Total payable <i class="fa fa-inr"></i> {{ selectedItemPrice }}</h4>
        </div>
      </div>
    </div>
